...
class TweetTopology
{
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("python-tweet-bolt", new SplitSentence(), 10).shuffleGrouping("tweet-spout");

    // attach the count bolt using fields grouping - parallelism of 15
    builder.setBolt("count-bolt", new CountBolt(), 15).fieldsGrouping("python-tweet-bolt", new Fields("word"));
