...
class TweetTopology
{
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("url-tweet-bolt", new URLBOLT(), 10).shuffleGrouping("tweet-spout");

    //************* replace Java ParseTweetBolt with Java/Python SplitSentence
    builder.setBolt("python-split-sentence", new SplitSentence(), 10).shuffleGrouping("url-tweet-bolt");
