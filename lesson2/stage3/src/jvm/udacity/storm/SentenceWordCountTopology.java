...
public class SentenceWordCountTopology {
   ...
   */
   static class SplitSentenceBolt extends BaseRichBolt {
           ...
           public void execute(Tuple tuple)
           {
             ...
             String delims = "[ .,?!]+";
             String[] tokens = words.split(delims);
              for (String new_s : tokens){
             collector.emit(new Values(new_s));}
  ...
  static class CountBolt extends BaseRichBolt {
      ...
      public static void main(String[] args) throws Exception
      {
        ...
        // splits the incoming sentences to words
        builder.setBolt("sentence-split" , new SplitSentenceBolt() , 15).shuffleGrouping("sentence-spout");

        // attach the count bolt using fields grouping - parallelism of 15
        builder.setBolt("count-bolt", new CountBolt(), 15).fieldsGrouping("sentence-split", new Fields("words"));
