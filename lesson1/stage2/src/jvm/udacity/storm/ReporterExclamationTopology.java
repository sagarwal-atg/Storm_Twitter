...
public class ReporterExclamationTopology {
  ...
  //  builder.setSpout("word", new TestWordSpout(), 10);
      builder.setSpout("rand-sentecnce", new RandomSentenceSpout(), 10 );
    // attach the exclamation bolt to the topology - parallelism of 3
    builder.setBolt("exclaim1", new ExclamationBolt(), 3).shuffleGrouping("rand-sentecnce");

    // attach another exclamation bolt to the topology - parallelism of 2
    builder.setBolt("exclaim2", new ExclamationBolt(), 2).shuffleGrouping("rand-sentecnce");
